...
- Make it possible to also set the difficulty of the set by tapping on it (currently that's the only missing thing when you tap, you can set weight, reps, comments, but not the difficulty).
- Make it so that whenever you press "Continue workout" it takes you to the next exercise you're supposed to do, right now it seems to start from the very beginning.
